...
ActiveRecord::Schema.define(version: 20150525065115) do

  create_table "item_categories", primary_key: "category_id", force: true do |t|
  ...
  create_table "item_features", primary_key: "feature_id", force: true do |t|
  ...
  create_table "item_item_categories", force: true do |t|
  ...
  add_index "item_item_categories", ["item_category_id"], name: "index_item_item_categories_on_item_category_id", using: :btree
  add_index "item_item_categories", ["item_id"], name: "index_item_item_categories_on_item_id", using: :btree

  create_table "items", primary_key: "mpn", force: true do |t|
